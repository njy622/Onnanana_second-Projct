...
(
	...
	title2 varchar2(1000) DEFAULT '',
	place varchar2(1000) DEFAULT '',
	startplace varchar2(1000) DEFAULT '',
	endplace varchar2(1000),
	smoke varchar2(1000) DEFAULT '',
	smoke2 varchar2(1000) DEFAULT '',
	waypoint1 varchar2(1000) DEFAULT '',
	waypoint2 varchar2(1000) DEFAULT '',
	waypoint3 varchar2(1000) DEFAULT '',
	PRIMARY KEY (sid)
);
