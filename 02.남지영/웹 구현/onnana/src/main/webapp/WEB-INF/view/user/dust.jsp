...
<body>
      ...
      <div class="row">
         ...
         <div class="col-6">
           ...
           <div class="button-container">
               ...
               <button onclick="changeImage('미세먼지질환.jpg', '미세먼지(PM-10)란?')" class="btn btn-outline-dark">미세먼지</button>
               <button onclick="changeImage('초미세먼지 질환.jpg', '초미세먼지(PM-2.5)란?')" class="btn btn-outline-dark">초미세먼지</button>
               <button onclick="changeImage('일산화탄소.jpg', '일산화탄소(CO)란?')" class="btn btn-outline-dark">일산화탄소</button>
               <button onclick="changeImage('이산화질소.jpg', '이산화질소(NO2)란?')" class="btn btn-outline-dark">이산화질소</button>
               <button onclick="changeImage('아황산가스.jpg', '아황산가스(SO2)란?')" class="btn btn-outline-dark">아황산가스</button>
               <button onclick="changeImage('대기오염물질(중금속).jpg', '중금속이란?')" class="btn btn-outline-dark">중금속</button>
           </div>
         </div>
   ...
   // 페이지 로드 시 초기 이미지와 설명을 표시하는 함수
      window.onload = function () {
        ...
        // 초기 버튼을 선택된 상태로 변경
        document.querySelector('.btn.btn-outline-dark.active').classList.remove('active'); // 기존에 선택된 버튼 클래스 제거
      ...
      function changeImage(imageName, descriptionTitle, descriptionContent) {
        ...
        document.getElementById('description-title').innerText = descriptionTitle;
