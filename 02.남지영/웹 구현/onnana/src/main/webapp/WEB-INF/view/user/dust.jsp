...
<script>
        document.addEventListener("DOMContentLoaded", function() {
            var buttons = [
                { x: 1200, y: 1000, text: "버튼 1" },
                { x: 800, y: 250, text: "버튼 2" },
                { x: 800, y: 350, text: "버튼 3" }
            ];
            ...
            buttons.forEach(function(btnInfo) {
                ...
                btn.onclick = function() {
                    ...
                    modalText.innerText = "버튼 " + btnInfo.text + "이 클릭되었습니다.";
		...
		<div class="row">
			...
			<div class="col-9">
			    ...
			    <div style="position: relative;">
			        <img src="/onnana/img/카토그램.png" alt="이미지" id="myImage">
